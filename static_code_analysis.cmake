...
if(clang-tidy_FOUND)
  if(run-clang-tidy_FOUND AND NOT WIN32)
    ADD_CUSTOM_TARGET(do-run-clang-tidy
      COMMAND ${run-clang-tidy_BINARY} -p ${CMAKE_BINARY_DIR} "-quiet" "-extra-arg-before=-std=c++17" "-checks=*,-fuchsia-default-arguments,-clang-analyzer-cplusplus.NewDeleteLeaks,-clang-diagnostic-ignored-optimization-argument,-readability-implicit-bool-conversion,-llvm-namespace-comment,-google-readability-namespace-comments"> ${CMAKE_BINARY_DIR}/run-clang-tidy.txt
