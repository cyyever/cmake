...
function(add_custom_build_type build_type)
  ...
  if(result)
    message(FATAL_ERROR "CMake build type ${build_type} has existed")
    return()
  endif()
  if(isMultiConfig)
...
function(add_custom_build_type_like build_type existed_build_type)
  ...
  foreach(lang IN LISTS languages)
    if(NOT ${CMAKE_${lang}_FLAGS_${existed_build_type}})
      message(FATAL_ERROR "Cannot find CMake variable CMAKE_${lang}_FLAGS_${existed_build_type} for build type ${existed_build_type} ")
    endif()
    set(CMAKE_${lang}_FLAGS_${build_type}
