...
if(clang-tidy_FOUND AND run-clang-tidy_FOUND AND clang-apply-replacements_FOUND AND NOT TARGET do_clang_tidy_fix)
    set(CHECKES "-checks='-*,modernize*,-modernize-use-trailing-return-type'")
    add_custom_target(
      do_clang_tidy_fix
