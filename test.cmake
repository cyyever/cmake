...
function(add_test_with_runtime_analysis)
  set(oneValueArgs TARGET MEMCHECK UBSAN HELGRIND ASAN)
  cmake_parse_arguments(this "NO_RUNTIME_ANALYSIS" "${oneValueArgs}" "ARGS" ${ARGN})
  ...
  if("${this_RUNTIME_ANALYSIS}" STREQUAL "")
    set(this_RUNTIME_ANALYSIS TRUE)
  endif()
